...
export const DashboardSidebar = ({ isSidebarCollapsed, isSidebarOpen, onNavigate }: DashboardSidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <button
        className="mt-5 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-brand-primary to-brand-secondary px-3 py-2.5 text-sm font-semibold text-white shadow-lg shadow-brand-primary/20 transition hover:scale-[1.015]"
        type="button"
      >
